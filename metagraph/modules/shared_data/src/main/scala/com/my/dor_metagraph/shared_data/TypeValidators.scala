...
import com.my.dor_metagraph.shared_data.Data.{DeviceCheckInRaw, State}
...
object TypeValidators {
  def validateCheckInTimestamp(oldState: State, deviceCheckInRaw: DeviceCheckInRaw, address: Address): DataApplicationValidationErrorOr[Unit] = {
