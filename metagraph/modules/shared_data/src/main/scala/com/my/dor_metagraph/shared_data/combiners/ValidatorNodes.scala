...
object ValidatorNodes {
   ...
   * */
  def getValidatorNodes(implicit securityProvider: SecurityProvider[IO]): (List[Address], List[Address]) = {
      ...
      getValidatorNodesAddresses(metagraphL0NodeUrl, dataL1NodeUrl, securityProvider)
  }
}
